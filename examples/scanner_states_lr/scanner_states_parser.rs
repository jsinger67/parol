...
static PARSE_TABLE: Lazy<LRParseTable> = Lazy::new(|| {
    LRParseTable::new(vec![
        ...
        LR1State {
            actions: collection! {
                0 /* '<$>' */ => LRAction::Reduce(3 /*Identifier*/, 10),
                5 /* '[a-zA-Z_]\w*' */ => LRAction::Reduce(3 /*Identifier*/, 10),
                9 /* '\u{22}' */ => LRAction::Reduce(3 /*Identifier*/, 10),
            },
            gotos: collection! {},
        },
        // State 3
        LR1State {
            actions: collection! {
                0 /* '<$>' */ => LRAction::Reduce(8 /*StringDelimiter*/, 14),
                5 /* '[a-zA-Z_]\w*' */ => LRAction::Reduce(8 /*StringDelimiter*/, 14),
                6 /* '\u{5c}[\u{22}\u{5c}bfnt]' */ => LRAction::Reduce(8 /*StringDelimiter*/, 14),
                7 /* '\u{5c}[\s^\n\r]*\r?\n' */ => LRAction::Reduce(8 /*StringDelimiter*/, 14),
                8 /* '[^\u{22}\u{5c}]+' */ => LRAction::Reduce(8 /*StringDelimiter*/, 14),
                9 /* '\u{22}' */ => LRAction::Reduce(8 /*StringDelimiter*/, 14),
            },
            gotos: collection! {},
        },
        // State 4
        ...
        LR1State {
            actions: collection! {
                6 /* '\u{5c}[\u{22}\u{5c}bfnt]' */ => LRAction::Shift(7),
                7 /* '\u{5c}[\s^\n\r]*\r?\n' */ => LRAction::Shift(8),
                8 /* '[^\u{22}\u{5c}]+' */ => LRAction::Shift(9),
                9 /* '\u{22}' */ => LRAction::Reduce(7 /*StringContent*/, 6),
            },
            gotos: collection! {
                1 /* Escaped */ => 10,
                2 /* EscapedLineEnd */ => 11,
        ...
        LR1State {
            actions: collection! {
                6 /* '\u{5c}[\u{22}\u{5c}bfnt]' */ => LRAction::Reduce(1 /*Escaped*/, 11),
                7 /* '\u{5c}[\s^\n\r]*\r?\n' */ => LRAction::Reduce(1 /*Escaped*/, 11),
                8 /* '[^\u{22}\u{5c}]+' */ => LRAction::Reduce(1 /*Escaped*/, 11),
                9 /* '\u{22}' */ => LRAction::Reduce(1 /*Escaped*/, 11),
            },
            gotos: collection! {},
        },
        // State 8
        LR1State {
            actions: collection! {
                6 /* '\u{5c}[\u{22}\u{5c}bfnt]' */ => LRAction::Reduce(2 /*EscapedLineEnd*/, 12),
                7 /* '\u{5c}[\s^\n\r]*\r?\n' */ => LRAction::Reduce(2 /*EscapedLineEnd*/, 12),
                8 /* '[^\u{22}\u{5c}]+' */ => LRAction::Reduce(2 /*EscapedLineEnd*/, 12),
                9 /* '\u{22}' */ => LRAction::Reduce(2 /*EscapedLineEnd*/, 12),
            },
            gotos: collection! {},
        },
        // State 9
        LR1State {
            actions: collection! {
                6 /* '\u{5c}[\u{22}\u{5c}bfnt]' */ => LRAction::Reduce(4 /*NoneQuote*/, 13),
                7 /* '\u{5c}[\s^\n\r]*\r?\n' */ => LRAction::Reduce(4 /*NoneQuote*/, 13),
                8 /* '[^\u{22}\u{5c}]+' */ => LRAction::Reduce(4 /*NoneQuote*/, 13),
                9 /* '\u{22}' */ => LRAction::Reduce(4 /*NoneQuote*/, 13),
            },
            gotos: collection! {},
        },
        // State 10
        LR1State {
            actions: collection! {
                6 /* '\u{5c}[\u{22}\u{5c}bfnt]' */ => LRAction::Reduce(9 /*StringElement*/, 7),
                7 /* '\u{5c}[\s^\n\r]*\r?\n' */ => LRAction::Reduce(9 /*StringElement*/, 7),
                8 /* '[^\u{22}\u{5c}]+' */ => LRAction::Reduce(9 /*StringElement*/, 7),
                9 /* '\u{22}' */ => LRAction::Reduce(9 /*StringElement*/, 7),
            },
            gotos: collection! {},
        },
        // State 11
        LR1State {
            actions: collection! {
                6 /* '\u{5c}[\u{22}\u{5c}bfnt]' */ => LRAction::Reduce(9 /*StringElement*/, 8),
                7 /* '\u{5c}[\s^\n\r]*\r?\n' */ => LRAction::Reduce(9 /*StringElement*/, 8),
                8 /* '[^\u{22}\u{5c}]+' */ => LRAction::Reduce(9 /*StringElement*/, 8),
                9 /* '\u{22}' */ => LRAction::Reduce(9 /*StringElement*/, 8),
            },
            gotos: collection! {},
        },
        // State 12
        LR1State {
            actions: collection! {
                6 /* '\u{5c}[\u{22}\u{5c}bfnt]' */ => LRAction::Reduce(9 /*StringElement*/, 9),
                7 /* '\u{5c}[\s^\n\r]*\r?\n' */ => LRAction::Reduce(9 /*StringElement*/, 9),
                8 /* '[^\u{22}\u{5c}]+' */ => LRAction::Reduce(9 /*StringElement*/, 9),
                9 /* '\u{22}' */ => LRAction::Reduce(9 /*StringElement*/, 9),
            },
            gotos: collection! {},
        },
        // State 13
...
pub const PRODUCTIONS: &[LRProduction; 15] = &[
