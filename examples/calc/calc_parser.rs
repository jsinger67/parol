...
pub const LOOKAHEAD_AUTOMATA: &[LookaheadDFA; 65] = &[
    ...
    LookaheadDFA {
        states: &[Some(0)],
        transitions: &[DFATransition(0, 0, 0)],
        k: 1,
    },
    /* 22 - "calc_lst1" */
    LookaheadDFA {
    ...
    /* 32 - "instruction" */
    LookaheadDFA {
        states: &[None, Some(5), Some(4), None, None],
        transitions: &[
            DFATransition(0, 15, 3),
            DFATransition(0, 18, 4),
            DFATransition(0, 20, 1),
            ...
            DFATransition(1, 9, 1),
            DFATransition(1, 9, 1),
            DFATransition(1, 10, 1),
            DFATransition(1, 10, 1),
            DFATransition(1, 11, 1),
            DFATransition(1, 11, 1),
            DFATransition(1, 12, 1),
            DFATransition(1, 12, 1),
            DFATransition(1, 13, 1),
            DFATransition(1, 13, 1),
            DFATransition(1, 14, 1),
            DFATransition(1, 14, 1),
            DFATransition(1, 15, 1),
            DFATransition(1, 15, 1),
            DFATransition(1, 16, 1),
            DFATransition(1, 16, 1),
            DFATransition(1, 17, 1),
            DFATransition(1, 17, 1),
            DFATransition(3, 15, 1),
            DFATransition(3, 18, 1),
            DFATransition(3, 20, 1),
            DFATransition(3, 21, 1),
            DFATransition(4, 15, 1),
            DFATransition(4, 18, 1),
            DFATransition(4, 20, 1),
            DFATransition(4, 21, 1),
        ],
        k: 2,
    },
    /* 33 - "logical_and" */
