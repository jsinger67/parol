    ...
    fn expected_children(&self) -> ExpectedChildrenKinds<TerminalKind, NonTerminalKind> {
        match self {
            ...
            Self::BitwiseAndOp => ExpectedChildrenKinds::Sequence(&[ChildKind {
                kind: NodeKind::Terminal(TerminalKind::BitwiseAndOp),
                attribute: ChildAttribute::Normal,
            }]),
            ...
            Self::BitwiseOrOp => ExpectedChildrenKinds::Sequence(&[ChildKind {
                kind: NodeKind::Terminal(TerminalKind::BitwiseOrOp),
                attribute: ChildAttribute::Normal,
            }]),
            ...
            Self::LogicalAndOp => ExpectedChildrenKinds::Sequence(&[ChildKind {
                kind: NodeKind::Terminal(TerminalKind::LogicalAndOp),
                attribute: ChildAttribute::Normal,
            }]),
            ...
            Self::LogicalOrOp => ExpectedChildrenKinds::Sequence(&[ChildKind {
                kind: NodeKind::Terminal(TerminalKind::LogicalOrOp),
                attribute: ChildAttribute::Normal,
            }]),
            ...
            Self::PowOp => ExpectedChildrenKinds::Sequence(&[ChildKind {
                kind: NodeKind::Terminal(TerminalKind::PowOp),
                attribute: ChildAttribute::Normal,
            }]),
    ...
    N: Node<'a, TerminalKind, NonTerminalKind>,
{
    ...
    pub fn find_bitwise_and_op(
        &self,
        cursor: usize,
    ) -> Result<Option<(usize, BitwiseAndOp<N>)>, N> {
        self.0
            .find_child(cursor, NodeKind::Terminal(TerminalKind::BitwiseAndOp))
    ...
    N: Node<'a, TerminalKind, NonTerminalKind>,
{
    ...
    pub fn find_bitwise_or_op(&self, cursor: usize) -> Result<Option<(usize, BitwiseOrOp<N>)>, N> {
        self.0
            .find_child(cursor, NodeKind::Terminal(TerminalKind::BitwiseOrOp))
    ...
    N: Node<'a, TerminalKind, NonTerminalKind>,
{
    ...
    pub fn find_logical_and_op(
        &self,
        cursor: usize,
    ) -> Result<Option<(usize, LogicalAndOp<N>)>, N> {
        self.0
            .find_child(cursor, NodeKind::Terminal(TerminalKind::LogicalAndOp))
    ...
    N: Node<'a, TerminalKind, NonTerminalKind>,
{
    ...
    pub fn find_logical_or_op(&self, cursor: usize) -> Result<Option<(usize, LogicalOrOp<N>)>, N> {
        self.0
            .find_child(cursor, NodeKind::Terminal(TerminalKind::LogicalOrOp))
    ...
    N: Node<'a, TerminalKind, NonTerminalKind>,
{
    ...
    pub fn find_pow_op(&self, cursor: usize) -> Result<Option<(usize, PowOp<N>)>, N> {
        self.0
            .find_child(cursor, NodeKind::Terminal(TerminalKind::PowOp))
