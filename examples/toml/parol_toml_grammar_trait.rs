...
impl TerminalEnum for TerminalKind {
    fn from_terminal_index(index: u16) -> Self {
        match index {
            ...
            15 => Self::Unicode4,
            16 => Self::Unicode8,
            17 => Self::MLBEscapedNL,
            18 => Self::LiteralCharNoApostrophe,
            19 => Self::HexPrefix,
            20 => Self::OctPrefix,
            21 => Self::BinPrefix,
            22 => Self::HexIntContent,
            23 => Self::OctIntContent,
            24 => Self::BinIntContent,
            25 => Self::True,
            26 => Self::False,
            27 => Self::NormalFloat,
            28 => Self::SpecialFloat,
            29 => Self::OffsetDateTime,
            30 => Self::LocalDateTime,
            31 => Self::LocalDate,
            32 => Self::LocalTime,
            33 => Self::ArraySep,
            34 => Self::ArrayTableOpen,
            35 => Self::ArrayTableClose,
            36 => Self::ArrayOpen,
            37 => Self::ArrayClose,
            38 => Self::InlineTableOpen,
            39 => Self::InlineTableClose,
            40 => Self::UnsignedDecInt,
            41 => Self::UnquotedKey,
            42 => Self::DotSep,
            43 => Self::MLBasicStringStart,
            44 => Self::MLBasicStringEnd,
            45 => Self::MLBQuotes,
            46 => Self::QuotationMark,
            47 => Self::MLLiteralStringStart,
            48 => Self::MLLiteralStringEnd,
            49 => Self::MLLQuotes,
            50 => Self::Apostrophe,
            51 => Self::AsciiNoEscape,
            52 => Self::Minus,
            53 => Self::Plus,
...
impl NonTerminalEnum for NonTerminalKind {
    fn from_non_terminal_name(name: &str) -> Self {
        match name {
            ...
            "Array" => Self::Array,
            "ArrayClose" => Self::ArrayClose,
            "ArrayOpen" => Self::ArrayOpen,
            "ArrayOpt" => Self::ArrayOpt,
            "ArraySep" => Self::ArraySep,
            "ArrayTable" => Self::ArrayTable,
            "ArrayTableClose" => Self::ArrayTableClose,
            "ArrayTableOpen" => Self::ArrayTableOpen,
            "ArrayValues" => Self::ArrayValues,
            "ArrayValuesSuffix" => Self::ArrayValuesSuffix,
            "ArrayValuesSuffix0" => Self::ArrayValuesSuffix0,
            "AsciiNoEscape" => Self::AsciiNoEscape,
            "BasicChar" => Self::BasicChar,
            "BasicString" => Self::BasicString,
            "BasicStringList" => Self::BasicStringList,
            "BasicUnescaped" => Self::BasicUnescaped,
            "BinInt" => Self::BinInt,
            "BinIntContent" => Self::BinIntContent,
            "BinPrefix" => Self::BinPrefix,
            "Boolean" => Self::Boolean,
            "DateTime" => Self::DateTime,
            "DecInt" => Self::DecInt,
            "DecIntOpt" => Self::DecIntOpt,
            "DecIntOptGroup" => Self::DecIntOptGroup,
            "DotSep" => Self::DotSep,
            "Escape" => Self::Escape,
            "EscapeSeqChar" => Self::EscapeSeqChar,
            "Escaped" => Self::Escaped,
            "Expression" => Self::Expression,
            "Float" => Self::Float,
            "HexInt" => Self::HexInt,
            "HexIntContent" => Self::HexIntContent,
            "HexPrefix" => Self::HexPrefix,
            "InlineTable" => Self::InlineTable,
            "InlineTableClose" => Self::InlineTableClose,
            "InlineTableKeyVals" => Self::InlineTableKeyVals,
            "InlineTableKeyValsOpt" => Self::InlineTableKeyValsOpt,
            "InlineTableOpen" => Self::InlineTableOpen,
            "InlineTableOpt" => Self::InlineTableOpt,
            "InlineTableOpt0" => Self::InlineTableOpt0,
            "InlineTableSep" => Self::InlineTableSep,
            "Integer" => Self::Integer,
            "Key" => Self::Key,
            "KeyList" => Self::KeyList,
            "KeySuffix" => Self::KeySuffix,
            "KeyVal" => Self::KeyVal,
            "KeyValSep" => Self::KeyValSep,
            "LiteralChar" => Self::LiteralChar,
            "LiteralCharNoApostrophe" => Self::LiteralCharNoApostrophe,
            "LiteralString" => Self::LiteralString,
            "LiteralStringList" => Self::LiteralStringList,
            "LocalDate" => Self::LocalDate,
            "LocalDateTime" => Self::LocalDateTime,
            "LocalTime" => Self::LocalTime,
            "MLBChar" => Self::MLBChar,
            "MLBContent" => Self::MLBContent,
            "MLBContentList" => Self::MLBContentList,
            "MLBContentList1" => Self::MLBContentList1,
            "MLBEscapedNL" => Self::MLBEscapedNL,
            "MLBQuotes" => Self::MLBQuotes,
            "MLBUnescaped" => Self::MLBUnescaped,
            "MLBasicBody" => Self::MLBasicBody,
            "MLBasicBodyList" => Self::MLBasicBodyList,
            "MLBasicString" => Self::MLBasicString,
            "MLBasicStringEnd" => Self::MLBasicStringEnd,
            "MLBasicStringStart" => Self::MLBasicStringStart,
            "MLLContent" => Self::MLLContent,
            "MLLContentList" => Self::MLLContentList,
            "MLLContentList1" => Self::MLLContentList1,
            "MLLQuotes" => Self::MLLQuotes,
            "MLLiteralBody" => Self::MLLiteralBody,
            "MLLiteralBodyList" => Self::MLLiteralBodyList,
            "MLLiteralString" => Self::MLLiteralString,
            "MLLiteralStringEnd" => Self::MLLiteralStringEnd,
            "MLLiteralStringStart" => Self::MLLiteralStringStart,
            "Minus" => Self::Minus,
            "Newline" => Self::Newline,
            "NonAscii" => Self::NonAscii,
            "NormalFloat" => Self::NormalFloat,
            "Numeric" => Self::Numeric,
            "OctInt" => Self::OctInt,
            "OctIntContent" => Self::OctIntContent,
            "OctPrefix" => Self::OctPrefix,
            "OffsetDateTime" => Self::OffsetDateTime,
            "ParolToml" => Self::ParolToml,
            "ParolTomlList" => Self::ParolTomlList,
            "Plus" => Self::Plus,
            "QuotationMark" => Self::QuotationMark,
            "QuotedKey" => Self::QuotedKey,
            "SimpleKey" => Self::SimpleKey,
            "SpecialFloat" => Self::SpecialFloat,
            "StdTable" => Self::StdTable,
            "StdTableClose" => Self::StdTableClose,
            "StdTableOpen" => Self::StdTableOpen,
            "Table" => Self::Table,
            "Unicode4" => Self::Unicode4,
            "Unicode8" => Self::Unicode8,
            "UnquotedKey" => Self::UnquotedKey,
            "UnsignedDecInt" => Self::UnsignedDecInt,
            "Val" => Self::Val,
            "WsNewline" => Self::WsNewline,
            "" => Self::Root,
