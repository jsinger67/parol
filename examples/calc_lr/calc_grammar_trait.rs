...
impl<'t, 'u> CalcGrammarAuto<'t, 'u> {
    ...
    fn calc(&mut self, _calc_list: &ParseTreeType<'t>) -> Result<()> {
        ...
        trace!("{}", self.trace_item_stack(context));
        let calc_list = pop_item!(self, calc_list, CalcList, context);
    ...
    ///
    /// `CalcList /* Vec<T>::Push */: CalcList Instruction ";"^ /* Clipped */;`
    ///
    #[parol_runtime::function_name::named]
    fn calc_list_0(
        &mut self,
    ...
    ///
    /// `AssignmentList /* Vec<T>::Push */: AssignmentList AssignItem;`
    ///
    #[parol_runtime::function_name::named]
    ...
    ///
    /// `LogicalOrList /* Vec<T>::Push */: LogicalOrList LogicalOrOp LogicalAnd;`
    ///
    #[parol_runtime::function_name::named]
    ...
    ///
    /// `LogicalAndList /* Vec<T>::Push */: LogicalAndList LogicalAndOp BitwiseOr;`
    ///
    #[parol_runtime::function_name::named]
    ...
    ///
    /// `BitwiseOrList /* Vec<T>::Push */: BitwiseOrList BitwiseOrOp BitwiseAnd;`
    ///
    #[parol_runtime::function_name::named]
    ...
    ///
    /// `BitwiseAndList /* Vec<T>::Push */: BitwiseAndList BitwiseAndOp Equality;`
    ///
    #[parol_runtime::function_name::named]
    ...
    ///
    /// `EqualityList /* Vec<T>::Push */: EqualityList EqualityOp Relational;`
    ///
    #[parol_runtime::function_name::named]
    fn equality_list_0(
        &mut self,
    ...
    ///
    /// `RelationalList /* Vec<T>::Push */: RelationalList RelationalOp BitwiseShift;`
    ///
    #[parol_runtime::function_name::named]
    ...
    ///
    /// `BitwiseShiftList /* Vec<T>::Push */: BitwiseShiftList BitwiseShiftOp Summ;`
    ///
    #[parol_runtime::function_name::named]
    ...
    ///
    /// `SummList /* Vec<T>::Push */: SummList AddOp Mult;`
    ///
    #[parol_runtime::function_name::named]
    fn summ_list_0(
        &mut self,
    ...
    ///
    /// `MultList /* Vec<T>::Push */: MultList MultOp Power;`
    ///
    #[parol_runtime::function_name::named]
    fn mult_list_0(
        &mut self,
    ...
    ///
    /// `PowerList /* Vec<T>::Push */: PowerList PowOp Factor;`
    ///
    #[parol_runtime::function_name::named]
    fn power_list_0(
        &mut self,
    ...
    ///
    #[parol_runtime::function_name::named]
    fn factor_1(&mut self, _negate: &ParseTreeType<'t>, _factor: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let factor = pop_item!(self, factor, Factor, context);
    ...
    ///
    #[parol_runtime::function_name::named]
    fn factor_2(&mut self, _id_ref: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
...
impl<'t> UserActionsTrait<'t> for CalcGrammarAuto<'t, '_> {
    ...
    fn call_semantic_action_for_production_number(
        ...
        match prod_num {
            ...
            55 => self.factor_1(&children[0], &children[1]),
            56 => self.factor_2(&children[0]),
