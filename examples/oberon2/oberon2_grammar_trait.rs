...
impl NonTerminalEnum for NonTerminalKind {
    fn from_non_terminal_name(name: &str) -> Self {
        match name {
            "AddOp" => Self::AddOp,
            "Case" => Self::Case,
            "CaseLabels" => Self::CaseLabels,
            "CaseLabelsOpt" => Self::CaseLabelsOpt,
            "CaseOpt" => Self::CaseOpt,
            "CaseOptList" => Self::CaseOptList,
            "Cases" => Self::Cases,
            "CasesList" => Self::CasesList,
            "Character" => Self::Character,
            "ConstDecl" => Self::ConstDecl,
            "ConstDeclBlock" => Self::ConstDeclBlock,
            "ConstDeclBlockList" => Self::ConstDeclBlockList,
            "ConstExpr" => Self::ConstExpr,
            "DeclBlock" => Self::DeclBlock,
            "DeclSeq" => Self::DeclSeq,
            "DeclSeqList" => Self::DeclSeqList,
            "DeclSeqList0" => Self::DeclSeqList0,
            "DeclSeqList0Group" => Self::DeclSeqList0Group,
            "Designator" => Self::Designator,
            "DesignatorList" => Self::DesignatorList,
            "DesignatorSuffix" => Self::DesignatorSuffix,
            "DoBlock" => Self::DoBlock,
            "Element" => Self::Element,
            "ElementOpt" => Self::ElementOpt,
            "ElsePart" => Self::ElsePart,
            "ElsifPart" => Self::ElsifPart,
            "Expr" => Self::Expr,
            "ExprList" => Self::ExprList,
            "ExprListList" => Self::ExprListList,
            "ExprOpt" => Self::ExprOpt,
            "FPSection" => Self::FPSection,
            "FPSectionList" => Self::FPSectionList,
            "FPSectionOpt" => Self::FPSectionOpt,
            "Factor" => Self::Factor,
            "FactorOpt" => Self::FactorOpt,
            "FactorOpt0" => Self::FactorOpt0,
            "FieldList" => Self::FieldList,
            "FieldListOpt" => Self::FieldListOpt,
            "ForInit" => Self::ForInit,
            "ForStep" => Self::ForStep,
            "FormalPars" => Self::FormalPars,
            "FormalParsOpt" => Self::FormalParsOpt,
            "FormalParsOpt0" => Self::FormalParsOpt0,
            "FormalParsOptList" => Self::FormalParsOptList,
            "ForwardDecl" => Self::ForwardDecl,
            "ForwardDeclOpt" => Self::ForwardDeclOpt,
            "ForwardDeclOpt0" => Self::ForwardDeclOpt0,
            "Guard" => Self::Guard,
            "GuardedDoBlock" => Self::GuardedDoBlock,
            "Ident" => Self::Ident,
            "IdentDef" => Self::IdentDef,
            "IdentDefOpt" => Self::IdentDefOpt,
            "IdentDefOptGroup" => Self::IdentDefOptGroup,
            "IdentList" => Self::IdentList,
            "IdentListList" => Self::IdentListList,
            "ImportList" => Self::ImportList,
            "ImportListList" => Self::ImportListList,
            "ImportListOpt" => Self::ImportListOpt,
            "ImportListOpt0" => Self::ImportListOpt0,
            "InOp" => Self::InOp,
            "Integer" => Self::Integer,
            "KwBegin" => Self::KwBegin,
            "KwCase" => Self::KwCase,
            "KwDo" => Self::KwDo,
            "KwElse" => Self::KwElse,
            "KwElsif" => Self::KwElsif,
            "KwEnd" => Self::KwEnd,
            "KwIf" => Self::KwIf,
            "KwOf" => Self::KwOf,
            "KwProcedure" => Self::KwProcedure,
            "KwThen" => Self::KwThen,
            "KwTo" => Self::KwTo,
            "KwVar" => Self::KwVar,
            "ModuleBody" => Self::ModuleBody,
            "ModuleHead" => Self::ModuleHead,
            "MulOp" => Self::MulOp,
            "Number" => Self::Number,
            "Oberon2" => Self::Oberon2,
            "Oberon2Opt" => Self::Oberon2Opt,
            "OptElsePartEnd" => Self::OptElsePartEnd,
            "OptElsePartEndOpt" => Self::OptElsePartEndOpt,
            "ProcDecl" => Self::ProcDecl,
            "ProcedureBody" => Self::ProcedureBody,
            "ProcedureHeading" => Self::ProcedureHeading,
            "ProcedureHeadingOpt" => Self::ProcedureHeadingOpt,
            "ProcedureHeadingOpt0" => Self::ProcedureHeadingOpt0,
            "QIdent" => Self::QIdent,
            "QualIdent" => Self::QualIdent,
            "Real" => Self::Real,
            "Receiver" => Self::Receiver,
            "ReceiverOpt" => Self::ReceiverOpt,
            "ReceiverVarDecl" => Self::ReceiverVarDecl,
            "Relation" => Self::Relation,
            "Set" => Self::Set,
            "SetOpt" => Self::SetOpt,
            "SetOptList" => Self::SetOptList,
            "SimpleExpr" => Self::SimpleExpr,
            "SimpleExprList" => Self::SimpleExprList,
            "SimpleExprOpt" => Self::SimpleExprOpt,
            "SimpleExprOptGroup" => Self::SimpleExprOptGroup,
            "Statement" => Self::Statement,
            "StatementBlock" => Self::StatementBlock,
            "StatementBlockOpt" => Self::StatementBlockOpt,
            "StatementOpt" => Self::StatementOpt,
            "StatementOpt0" => Self::StatementOpt0,
            "StatementOpt1" => Self::StatementOpt1,
            "StatementOpt2" => Self::StatementOpt2,
            "StatementOpt3" => Self::StatementOpt3,
            "StatementOptGroup" => Self::StatementOptGroup,
            "StatementOptGroupList" => Self::StatementOptGroupList,
            "StatementOptGroupList0" => Self::StatementOptGroupList0,
            "StatementOptGroupSuffix" => Self::StatementOptGroupSuffix,
            "StatementSeq" => Self::StatementSeq,
            "StatementSeqList" => Self::StatementSeqList,
            "String" => Self::String,
            "Term" => Self::Term,
            "TermList" => Self::TermList,
            "ThenBlock" => Self::ThenBlock,
            "TypeDecl" => Self::TypeDecl,
            "TypeDeclBlock" => Self::TypeDeclBlock,
            "TypeDeclBlockList" => Self::TypeDeclBlockList,
            "TypeDef" => Self::TypeDef,
            "TypeDefList" => Self::TypeDefList,
            "TypeDefOpt" => Self::TypeDefOpt,
            "TypeDefOpt0" => Self::TypeDefOpt0,
            "TypeDefOpt1" => Self::TypeDefOpt1,
            "TypeDefOptList" => Self::TypeDefOptList,
            "VarDecl" => Self::VarDecl,
            "VarDeclBlock" => Self::VarDeclBlock,
            "VarDeclBlockList" => Self::VarDeclBlockList,
            "" => Self::Root,
