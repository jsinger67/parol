...
Here I provide the definition of the PAR grammar in EBNF. It is actually written in PAR syntax and
can be found here [parol_grammar.par](../src/parser/parol-grammar.par).
...
[calc.par](../examples/calc/calc.par):
