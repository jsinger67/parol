...
impl<'t, 'u> ParolLsGrammarAuto<'t, 'u> {
    ...
    fn declaration_4(
        ...
        let declaration_4_built = DeclarationPercentGrammarUnderscoreTypeLiteralString {
            percent_grammar_underscore_type,
            literal_string,
        };
        let declaration_4_built =
            Declaration::PercentGrammarUnderscoreTypeLiteralString(declaration_4_built);
        // Calling user action here
...
impl<'t> UserActionsTrait<'t> for ParolLsGrammarAuto<'t, '_> {
    ...
    fn call_semantic_action_for_production_number(
        ...
        match prod_num {
            ...
            22 => self.production_l_h_s(&children[0], &children[1]),
            23 => self.production(&children[0], &children[1], &children[2]),
            ...
            50 => self.group(&children[0], &children[1], &children[2]),
            51 => self.optional(&children[0], &children[1], &children[2]),
            52 => self.repeat(&children[0], &children[1], &children[2]),
            53 => self.non_terminal(&children[0], &children[1]),
            54 => self.non_terminal_opt_0(&children[0]),
            55 => self.non_terminal_opt_1(),
            56 => self.identifier(&children[0]),
            57 => self.string(&children[0]),
            58 => self.literal_string(&children[0]),
