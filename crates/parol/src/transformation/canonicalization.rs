...
mod test {
    ...
    fn eliminate_single_rep_case_1_lr() {
        ...
        let productions = eliminate_single_rep(
            std::slice::from_ref(&production.lhs.clone()),
            0,
            GrammarType::LALR1,
            production,
        );
    ...
    fn eliminate_single_opt_case_1() {
        ...
        let productions =
            eliminate_single_opt(std::slice::from_ref(&production.lhs.clone()), 0, production);
    ...
    fn eliminate_single_grp_case_1() {
        ...
        let productions =
            eliminate_single_grp(std::slice::from_ref(&production.lhs.clone()), 0, production);
