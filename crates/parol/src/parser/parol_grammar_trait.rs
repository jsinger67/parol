...
pub trait ParolGrammarTrait<'t> {
    ...
    fn scanner_state_directives(&mut self, _arg: &ScannerStateDirectives<'t>) -> Result<()> {
        Ok(())
    }
...
///
/// `ScannerDirectives: '%on'^ /* Clipped */ IdentifierList ScannerStateDirectives;`
///
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct ScannerDirectivesPercentOnIdentifierListScannerStateDirectives<'t> {
    pub identifier_list: IdentifierList<'t>,
    pub scanner_state_directives: crate::parser::parol_grammar::ScannerStateSwitch,
}

///
/// Type derived for production 19
///
/// `ScannerDirectives: '%allow_unmatched'^ /* Clipped */;`
///
#[allow(dead_code)]
#[derive(Debug, Clone)]
...
///
/// `ScannerStateDirectives: '%enter'^ /* Clipped */ Identifier;`
///
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct ScannerStateDirectivesPercentEnterIdentifier<'t> {
    pub identifier: Identifier<'t>,
}
...
///
/// `ScannerStateDirectives: '%push'^ /* Clipped */ Identifier;`
///
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct ScannerStateDirectivesPercentPushIdentifier<'t> {
    pub identifier: Identifier<'t>,
}
...
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct ScannerStateDirectivesPercentPop<'t> {
...
pub enum ScannerDirectives<'t> {
    ...
    PercentOnIdentifierListScannerStateDirectives(
        ScannerDirectivesPercentOnIdentifierListScannerStateDirectives<'t>,
    ),
...
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub enum ScannerStateDirectives<'t> {
    PercentEnterIdentifier(ScannerStateDirectivesPercentEnterIdentifier<'t>),
    PercentPushIdentifier(ScannerStateDirectivesPercentPushIdentifier<'t>),
    PercentPop(ScannerStateDirectivesPercentPop<'t>),
}
...
pub enum ASTType<'t> {
    ...
    ScannerStateDirectives(ScannerStateDirectives<'t>),
...
impl<'t, 'u> ParolGrammarAuto<'t, 'u> {
    ...
    fn declaration_5(
        ...
        let declaration_5_built = DeclarationPercentGrammarUnderscoreTypeRawString { raw_string };
        let declaration_5_built =
            Declaration::PercentGrammarUnderscoreTypeRawString(declaration_5_built);
        // Calling user action here
    ...
    fn scanner_directives_4(
        ...
        let scanner_directives_4_built =
            ScannerDirectivesPercentOnIdentifierListScannerStateDirectives {
                identifier_list,
                scanner_state_directives: (&scanner_state_directives)
                    .try_into()
                    .map_err(parol_runtime::ParolError::UserError)?,
            };
        let scanner_directives_4_built =
    ...
    fn scanner_directives_5(
        &mut self,
        _percent_allow_underscore_unmatched: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let scanner_directives_5_built = ScannerDirectivesPercentAllowUnderscoreUnmatched {};
        let scanner_directives_5_built =
            ScannerDirectives::PercentAllowUnderscoreUnmatched(scanner_directives_5_built);
        // Calling user action here
        self.user_grammar
    ...
    fn scanner_state_directives_0(
        ...
        let scanner_state_directives_0_built =
            ScannerStateDirectivesPercentEnterIdentifier { identifier };
        let scanner_state_directives_0_built =
    ...
    fn scanner_state_directives_1(
        ...
        let scanner_state_directives_1_built =
            ScannerStateDirectivesPercentPushIdentifier { identifier };
        let scanner_state_directives_1_built =
...
impl<'t> UserActionsTrait<'t> for ParolGrammarAuto<'t, '_> {
    ...
    fn call_semantic_action_for_production_number(
        ...
        match prod_num {
            ...
            18 => self.scanner_directives_4(&children[0], &children[1], &children[2]),
            19 => self.scanner_directives_5(&children[0]),
            20 => self.scanner_state_directives_0(&children[0], &children[1]),
            21 => self.scanner_state_directives_1(&children[0], &children[1]),
            22 => self.scanner_state_directives_2(&children[0]),
            23 => self.grammar_definition(&children[0], &children[1], &children[2]),
            24 => self.grammar_definition_list_0(&children[0], &children[1]),
            25 => self.grammar_definition_list_1(),
            26 => self.double_colon(&children[0]),
            27 => self.production(&children[0], &children[1], &children[2], &children[3]),
            28 => self.alternations(&children[0], &children[1]),
            29 => self.alternations_list_0(&children[0], &children[1], &children[2]),
            30 => self.alternations_list_1(),
            31 => self.alternation(&children[0]),
            32 => self.alternation_list_0(&children[0], &children[1]),
            33 => self.alternation_list_1(),
            34 => self.factor_0(&children[0]),
            35 => self.factor_1(&children[0]),
            36 => self.factor_2(&children[0]),
            37 => self.factor_3(&children[0]),
            38 => self.symbol_0(&children[0]),
            39 => self.symbol_1(&children[0]),
            40 => self.symbol_2(&children[0]),
            41 => self.token_literal_0(&children[0]),
            42 => self.token_literal_1(&children[0]),
            43 => self.token_literal_2(&children[0]),
            44 => self.token_expression(&children[0], &children[1]),
            45 => self.token_expression_opt_0(&children[0]),
            46 => self.token_expression_opt_1(),
            47 => self.simple_token(&children[0], &children[1]),
            48 => self.simple_token_opt_0(&children[0]),
            49 => self.simple_token_opt_1(),
            50 => self.token_with_states(
                &children[0],
                &children[1],
                &children[2],
                &children[3],
            ...
            51 => self.token_with_states_opt_0(&children[0]),
            52 => self.token_with_states_opt_1(),
            53 => self.string(&children[0]),
            54 => self.raw_string(&children[0]),
            55 => self.regex(&children[0]),
            56 => self.group(&children[0], &children[1], &children[2]),
            57 => self.optional(&children[0], &children[1], &children[2]),
            58 => self.repeat(&children[0], &children[1], &children[2]),
            59 => self.non_terminal(&children[0], &children[1]),
            60 => self.non_terminal_opt_0(&children[0]),
            61 => self.non_terminal_opt_1(),
            62 => self.identifier(&children[0]),
            63 => self.scanner_state(
                &children[0],
                &children[1],
                &children[2],
                &children[3],
            ...
            64 => self.scanner_state_list_0(&children[0], &children[1]),
            65 => self.scanner_state_list_1(),
            66 => self.identifier_list(&children[0], &children[1]),
            67 => self.identifier_list_list_0(&children[0], &children[1], &children[2]),
            68 => self.identifier_list_list_1(),
