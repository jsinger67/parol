...
It is a struct with four members. The first and the last are Option types. And this might remind us
...
Each of the contained enum variants hold a dedicated struct type that in turn corresponds to the
