...
fn main() {
    // CLI equivalent is:
    // parol -f ./snapshot_lib.par -e ./snapshot_lib-exp.par -p ./src/snapshot_lib_parser.rs -a ./src/snapshot_lib_grammar_trait.rs -t SnapshotLibGrammar -m snapshot_lib_grammar
